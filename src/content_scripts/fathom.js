// Content script for Fathom.video
console.log('Fathom content script loaded');
...
function checkLoginStatus() {
  ...
  if (isLoggedIn) {
    console.log('User is logged in to Fathom');
    ...
    chrome.runtime.sendMessage({
      ...
      if (response?.success) {
        console.log('Fathom login processed successfully');
      }
    });
  }
}
